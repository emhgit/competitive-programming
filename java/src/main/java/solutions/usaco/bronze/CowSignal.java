...
public class CowSignal {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("java/src/input/cowsignal.in"));
        PrintWriter out = new PrintWriter(new FileWriter("java/src/output/cowsignal.out"));
        StringTokenizer st;
